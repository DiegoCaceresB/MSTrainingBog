...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            var uriBase = Environment.GetEnvironmentVariable("https://tollboothvisioninit89281.cognitiveservices.azure.com/");
            var apiKey = Environment.GetEnvironmentVariable("ba4c78a543884640a8e6fa1c09cf78dd");
